...
object QueueReconstructionByHeight extends App {
  def reconstructQueue(people: Array[Array[Int]]): Array[Array[Int]] =
    people.sortBy(arr => (arr.head, arr.last))(Ordering.Tuple2(Ordering.Int.reverse, Ordering.Int)).foldLeft(scala.collection.mutable.ListBuffer[Array[Int]]()) { (res, p) => res.insert(p.last, p); res }.toArray
...
//Runtime: 952 ms, faster than 100.00% of Scala online submissions for Queue Reconstruction by Height.
//Memory Usage: 90.5 MB, less than 69.00% of Scala online submissions for Queue Reconstruction by Height.