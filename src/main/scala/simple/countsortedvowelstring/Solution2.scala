...
//Runtime: 6015 ms, faster than 50.00% of Scala online submissions for Count Sorted Vowel Strings.
//Memory Usage: 735.7 MB, less than 50.00% of Scala online submissions for Count Sorted Vowel Strings.