...
class StringToIntegerTest extends AnyFlatSpec with should.Matchers {
  "ATOI" should "parse an string to integer" in {
  ...
  "ATOI" should "parse an string with spaces to integer" in {
    StringToInteger.myAtoi("   42") should be(42)
    StringToInteger.myAtoi("   42  ") should be(42)
    StringToInteger.myAtoi("   -42") should be(-42)
    StringToInteger.myAtoi("   -42  ") should be(-42)
  ...
  "ATOI" should "parse an string with signs to integer" in {
    StringToInteger.myAtoi("   +42") should be(42)
    StringToInteger.myAtoi("   +42+") should be(42)
    StringToInteger.myAtoi("   -42") should be(-42)
    StringToInteger.myAtoi("   -42-") should be(-42)
  ...
  "ATOI" should "parse an string with alphabets to integer" in {
  ...
  "ATOI" should "parse an string with edge cases to integer" in {
    StringToInteger.myAtoi(Int.MaxValue.toString) should be(Int.MaxValue)
    StringToInteger.myAtoi(Int.MinValue.toString) should be(Int.MinValue)
  ...
  "ATOI" should "parse an string with boundary cases to integer" in {
